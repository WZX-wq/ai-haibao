...
export const font2style = async (fontContent, fontData = []) => {
    return new Promise((resolve) => {
        Promise.all(Object.keys(fontContent).map(async (key) => {
            const font = fontData.find((font) => font.value === key);
            if (font.id) {
...
//# sourceMappingURL=loadFontRule.js.map