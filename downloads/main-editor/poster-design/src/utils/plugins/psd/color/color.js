...
export const RGBA2HexA = (r, g, b, a = 1) => {
...
export const change2Hex = (color) => {
    const reVal = color.replace('rgba(', '').replace(')', '');
    let a = 1;
    let hex = color.substring(0, 7);
...
export const RGBA2HSLA = (r, g, b, a = 1) => [...RGB2HSL(r, g, b), a];
...
export const HSLA2RGBA = (h, s, l, a = 1) => [...HSL2RGB(h, s, l), a];
export const HSL2Hex = (h, s, l) => {
    const [r, g, b] = HSL2RGB(h, s, l);
    return RGB2Hex(r, g, b);
};
export const HSLA2HexA = (h, s, l, a = 1) => {
