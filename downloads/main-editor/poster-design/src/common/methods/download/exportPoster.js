...
async function renderPosterCanvas(canvasId) {
...
export async function exportPoster(fileName, format, canvasId = 'page-design-canvas') {
...
//# sourceMappingURL=exportPoster.js.map
